...
describe('downloadAurnController', () => {
  ...
  describe('successful download flow', () => {
    it(
      'returns jobID for JS route (no server-side polling)',
      async () => {
    ...
    it(
      'renders no-JS template for no-JS route (with server-side polling)',
      async () => {
  ...
  describe('API params', () => {
    it(
      'constructs params including regiontype',
      async () => {
    ...
    it(
      'handles LocalAuthority region type',
      async () => {
        mockRequest.yar.get.mockImplementation((key) => {
          const values = {
  ...
  describe('session management', () => {
    it(
      'reads required session variables for JS route',
      async () => {
    ...
    it(
      'sets downloadaurnresult in session for no-JS route only',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
  ...
  describe('route detection', () => {
    it(
      'detects JS route by pathname (returns jobID)',
      async () => {
    ...
    it(
      'detects no-JS route by pathname (renders view with polling)',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
  ...
  describe('view data merge', () => {
    it(
      'merges viewDatanojs with result for no-JS template',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
    ...
    it(
      'handles missing viewDatanojs gracefully',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
        mockRequest.yar.get.mockImplementation((key) => {
          const values = {
  ...
  describe('error handling', () => {
    it(
      'handles download API error for JS route',
      async () => {
    ...
    it(
      'handles download API error with custom error object for JS route',
      async () => {
    ...
    it(
      'handles download error and returns error object for no-JS route',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
    ...
    it(
      'handles polling error for no-JS route',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
    ...
    it(
      'handles missing config URL for download',
      async () => {
        config.get.mockImplementation((key) => {
    ...
    it(
      'handles missing config URL for polling',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
  ...
  describe('edge cases and data variations', () => {
    it(
      'handles multiple locations for Country region',
      async () => {
        mockRequest.yar.get.mockImplementation((key) => {
          const values = {
    ...
    it(
      'handles multiple LocalAuthority IDs',
      async () => {
        mockRequest.yar.get.mockImplementation((key) => {
          const values = {
    ...
    it(
      'includes correct dataselectorfiltertype and downloadtype',
      async () => {
    ...
    it(
      'handles empty viewDatanojs with all properties',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
        mockRequest.yar.get.mockImplementation((key) => {
          const values = {
    ...
    it(
      'handles polling with single immediate completion',
      async () => {
        mockRequest.url.pathname = '/download_aurn_nojs/2024'
    ...
    it(
      'handles null or undefined session values gracefully',
      async () => {
        mockRequest.yar.get.mockImplementation((key) => {
          const values = {
    ...
    it(
      'logs API parameters before making request',
      async () => {
